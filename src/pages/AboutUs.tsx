...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Über Uhlen Mineralöl | Ihr zuverlässiger Heizöl-Partner</title>
        <meta name="description" content="Erfahren Sie mehr über Uhlen Mineralöl - H.T.U GmbH. Qualität, Service und Nachhaltigkeit seit 2002. Ihr Partner für Heizöl in Deutschland." />
      </Helmet>
      <Header />
      ...
      <section className="bg-gradient-to-br from-primary-50 to-primary-100 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-8">
            Seit 2002 Ihr zuverlässiger Partner für Premium-Heizöl in Deutschland. 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                <p>
                  Im Jahr 2002 wurde H.T.U GmbH mit dem Ziel gegründet, 
                  Kunden in Deutschland mit hochwertigem Heizöl zu fairen Preisen zu versorgen. 
                  Was als Unternehmen in Meppen begann, hat sich zu einem der 
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl p-12 text-white text-center shadow-2xl">
                ...
                <h3 className="text-3xl font-bold mb-4">Uhlen Mineralöl</h3>
                <p className="text-xl text-primary-100 mb-6">H.T.U GmbH</p>
                <div className="space-y-2 text-primary-100">
                  <p>Seit 2002 in Meppen</p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Warum Heizöl von Uhlen Mineralöl wählen?
            </h2>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <span className="text-gray-700">info@uhlen-mineraloel.de</span>
                      </div>
                    </div>
                  </div>
